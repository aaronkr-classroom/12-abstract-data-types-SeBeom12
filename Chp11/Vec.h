...
using namespace std; //std::max, std::uninitialized_fill, std::unitialized_copy, allocator
//Vec 클래스추상 데이터타입
...
private:
	...
	iterator avail; // 마지막 요소의 다음을 가리키는 포인터
